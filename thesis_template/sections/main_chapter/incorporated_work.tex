...
If it detects the end of a segmentation, it will enhance the corresponding audio chunk with a segmentation\_ended annotation, as described in chapter TODO, before sending it.
...
Small changes were required for it to meet all our pipeline's expectations, so we improved it to include a probability for each result. %TODO
...
It should be noted that the data set was quite small with only 339 data points, 188 of which were female, 151 male. % TODO small why? 
