...
When we synchronize the results, with respect to what do we synchronize?
...
As results are stored permanently, we are able to simply load an already existing database.
