...
With respect to one of the secondary goals of this thesis, to provide a modular framework, we can also not assume every components algorithm to work with a specific audio format.
...
However, as we already always employ an additional program to synchronize the results, namely the Orchestrator, the benefit of the distributed approach becomes negligible.
