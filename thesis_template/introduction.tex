...
\chapter{Basics}
In this chapter, we will provide an overview and describe a number of concepts and technologies used within this work.
...
However, while we cannot alter the laws of physics, we might be able to reduce latency when we are in control of the environment.
...
In this particular work, we will almost exclusively talk about latency of audio signals.
...
In chapter \ref{eval:dataset} we will show a particular speech recognizer to just spend 0.063 seconds processing audio, with an average signal length of about one and a half seconds.
