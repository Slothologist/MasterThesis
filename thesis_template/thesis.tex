...
\title{A configurable speech recognition pipeline for social robots: Creating a Fusion Framework for analysing speech data}
\author{Robert Feldhans}
\institution{University of Bielefeld,Technical Faculty, Central Lab Facilities}
\supervisors{Dr.-Ing.\@~Sven Wachsmuth,M.Sc.\@~Florian Lier}
% addidional input by M.Sc.\@~Birte Carlmeyer
%\internalid{M13}
