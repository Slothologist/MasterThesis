...
The recognition rate as control variable showed us that our pipeline can not be compared to the pre-existing solution without restriction.
As a number of factors, i.e. all components of my pipeline apart from the \gls{ps} speech recognizer, were independent from this control variable, I felt confident to compare them nevertheless.
